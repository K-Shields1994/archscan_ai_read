...
def start_read_gui(handle_folder_upload, handle_save_output):
    '''
    Starts the Tkinter GUI 
    '''
    #Initialize variables to hold selected folder 
    ...
    #Button frame within main frame 
