    ...
    with open(input_file, "rb") as input_pdf_stream:
        ...
        for page_id, page in enumerate(ocr_results.pages):
            ...
            for word in page.words:
                ...
                # Set font and place the text with the correct transformation (for rotation)
                text.setFont(default_font, font_size)
                text.setTextTransform(math.cos(math.radians(word_rotation)),
                ...
                # Render the text invisibly for searchability
            ...
            # Prepare the overlay for merging
            ocr_overlay.seek(0)
